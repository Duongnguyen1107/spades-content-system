...
Đây là giọng văn chung cho tất cả bài viết Spades. Không được phép drift sang tone khác.
...
**TUYỆT ĐỐI KHÔNG:**
- **KHÔNG dùng em-dash (—) ở bất kỳ đâu trong body bài** — thay bằng dấu phẩy, xuống dòng, hoặc viết lại câu
...
Đọc lại toàn bộ bài, tìm ký tự "—". Nếu thấy → xóa và viết lại câu đó trước khi output. Không có ngoại lệ.
